...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .topbar h1 { font-size: 15px; font-weight: 700; letter-spacing: 0; display: flex; align-items: center; gap: 6px; background: var(--bg3); color: var(--text); padding: 2px 16px; border: 1px solid #000000; position: absolute; left: 50%; transform: translateX(-50%); z-index: 1; }
    ...
    body.light-mode .panel-tab.active { background: #000000; color: #FFFFFF; }
    ...
    .gb-msg { margin-top: 10px; white-space: pre-wrap; font-family: "Courier New", monospace; }
  ...
  <div class="app">
    ...
    <div class="main-area">
      <div class="sidebar">
        ...
        <a href="/?section=guestbook" class="panel-tab \${section === 'guestbook' ? 'active' : ''}">留言板 (Guestbook)</a>
