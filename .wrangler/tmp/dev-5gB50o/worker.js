...
// .wrangler/tmp/bundle-4eW18I/checked-fetch.js
...
<p>\u5982\u679C\u4F60\u6709\u4EC0\u4E48\u60F3\u5BF9\u6211\u8BF4\u7684\uFF0C\u6B22\u8FCE\u968F\u65F6\u8054\u7CFB\u6211~</p>`;
  ...
  function renderPostImages(imageUrlStr) {
    ...
    if (urls2.length === 1) {
      return `<img src="${urls2[0]}" class="post-image" onclick="openLightbox('${urls2[0]}')">`;
    }
    return `<div class="post-images-grid">
      ${urls2.map((u) => `<img src="${u}" class="post-image grid-img" onclick="openLightbox('${u}')">`).join("")}
    </div>`;
  }
...
<body>
  ...
  <script>
    ...
    async window.deletePost = async function(id) {
...
// .wrangler/tmp/bundle-4eW18I/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4eW18I/middleware-loader.entry.ts
