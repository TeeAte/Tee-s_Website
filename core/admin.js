      ...
      if (uploadedImageUrls.length > 0) {
        ...
        uploadedImageUrls.forEach((url, idx) => {
          container.innerHTML += "<div style='position:relative; width:80px; height:80px;'>" +
            ...
            "<button onclick='event.stopPropagation(); removeImage(" + idx + ")' style='position:absolute; top:-5px; right:-5px; background:var(--text); color:var(--bg); border:none; border-radius:50%; width:20px; height:20px; cursor:pointer; font-weight:bold; box-shadow: 1px 1px 0 #000;'>×</button>" +
          "</div>";
        });
      } else {
